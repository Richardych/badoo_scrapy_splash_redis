...
class Renspider(scrapy.spiders.Spider):
    ...
    def __init__(self, mbegin=None,mend=None, mcountry=None, murl='1', *args, **kwargs):
...
'Upgrade-Insecure-Requests':'1'
	...
	if len(photo_id_list) >= 1:
	    murl = "https://us1.badoo.com/"+str(uid)+'/'+str(photo_id_list[0])
...
{'png': 0,
 ...
 'html': 1,
 'wait': 0.5,
},'endpoint': 'render.html',		#'render.png',    #render.json    render.html
'splash_url': 'http://172.17.0.'+ self.MURL +':8050/',
